...
def compute_sample_weight(y, n_classes=2, class_weight=None, eps=1e-8):
    ...
    Default behavior to balance class weights but class_weight can be passed
    as argument.
    ...
    >>> compute_sample_weight(y, n_classes=2,
                              class_weight=pt.FloatTensor([.4, .6]))
        1.3636
        0.9091
        0.9091
        0.9091
    ...
    weights = pt.mm(y_onehot, class_weight.view(-1, 1)).squeeze()
